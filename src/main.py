...
layout_stage_off = od.get_pitching_OFF_design(design_compressor, atm, layout_stage, blade_cascade)
...
# viz.viz_VSV_stragger_rotor(path, layout_stage_off_mat[0], layout_stage_off_mat[-1], layout_stage_off_VSV_Design)
