...
def max_min_m_dot_off_design_compressor(m_dot_array_search, RPM_pourcentage, design_compressor, atm, layout_stage, blade_cascade) :
    valid_m_dot = []
    compressors_mat = []
    ...
    for m_d in m_dot_array_search:   
        try:
            ...
            layout_stage_off = get_pitching_OFF_design(compressor, atm, layout_stage, blade_cascade)
...
def eff_OPR_off_design_compressor(m_dot_array, n_dot_array, design_compressor, atm, layout_stage, blade_cascade) :
